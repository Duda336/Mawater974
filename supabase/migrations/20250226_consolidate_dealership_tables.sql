...
-- 7. Update is_active and is_verified for approved dealerships
-- Removed this section as is_active and is_verified fields are removed from the dealerships table

-- 8. Create function to approve dealership
...
-- 9. Create function to reject dealership
...
-- 10. Create a view for backward compatibility (optional)
