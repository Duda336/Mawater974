...
export default function ContactPage() {
  ...
  return (
    <div 
      className={`min-h-screen py-12 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-800'}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                <div className={`p-3 rounded-full mr-4 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'}`}>
                  <FontAwesomeIcon icon={faPhone} className="text-qatar-maroon" />
                </div>
                <div>
              ...
              <div className="flex items-start">
                <div className={`p-3 rounded-full mr-4 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'}`}>
                  <FontAwesomeIcon icon={faClock} className="text-qatar-maroon" />
                </div>
                <div>
